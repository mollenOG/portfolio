...
export const searchResults: Content[] = [
  {
    ...
    link: 'https://github.com/pythonforfinance',
    // image: (
    //   <Image
  ...
  {
    title: 'Crypto Bots',
    description: <>I like to automate my trades so that i can make passive income, so this the repo containing my codes for python</>,
    link: 'https://github.com/mollenOG/TradingBots',
    // image: (
    //   <Image
    //     src="https://avatars.githubusercontent.com/u/69631?s=200&v=4"
    //     alt="meta logo"
  ...
  {
    title: 'Quant',
    description: <>Well, trying to get into Quant. Getting hands on with python and mathematics. Finance and Technology. </>,
    link: 'https://github.com/mollenOG/AlgoTrading',
    // image: (
    //   <Image
    //     src="https://avatars.githubusercontent.com/u/69631?s=200&v=4"
    //     alt="meta logo"
  ...
  {
    title: 'Crypto Bots',
    description: <>Building a AI SaaS product....need some money </>,
    link: 'https://github.com/mollenOG/AISaaS',
    // image: (
    //   <Image
    //     src="https://avatars.githubusercontent.com/u/69631?s=200&v=4"
    //     alt="meta logo"
  ...
  {
    title: 'Blogs',
    description: <>I like to do showoff of what i know...hence a blog </>,
    link: 'https://mollenog.hashnode.dev',
    // image: (
    //   <Image
    //     src="https://avatars.githubusercontent.com/u/69631?s=200&v=4"
    //     alt="meta logo"
